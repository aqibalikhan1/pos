...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="stats-card">
            ...
            <div class="stats-card-title">Total Suppliers</div>
            <div class="stats-card-value">{{ $suppliers->count() }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Active Suppliers</div>
            <div class="stats-card-value">{{ $suppliers->where('is_active', true)->count() }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Inactive Suppliers</div>
            <div class="stats-card-value">{{ $suppliers->where('is_active', false)->count() }}</div>
        </div>
    </div>
