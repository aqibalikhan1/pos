...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="md-card">
        <div class="md-card-header">
            <h2 class="md-card-title">Edit Supplier Details</h2>
            <p class="text-sm text-gray-600">Update the information below to modify supplier details.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="supplier_type" 
                            ...
                            <option value="Importer" {{ old('supplier_type', $supplier->supplier_type) == 'Importer' ? 'selected' : '' }}>Importer</option>
                        </select>
                        @error('supplier_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="payment_terms" 
                            ...
                            <option value="45 Days" {{ old('payment_terms', $supplier->payment_terms) == '45 Days' ? 'selected' : '' }}>45 Days</option>
                            <option value="60 Days" {{ old('payment_terms', $supplier->payment_terms) == '60 Days' ? 'selected' : '' }}>60 Days</option>
                        </select>
                        @error('payment_terms')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
