        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Update the supplier's information</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <textarea name="address" 
                                      ...
                                      placeholder="Enter the supplier's complete address...">{{ old('address', $supplier->address) }}</textarea>
