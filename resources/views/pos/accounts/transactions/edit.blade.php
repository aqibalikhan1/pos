...
@section('title', 'Edit Account Transaction')
@section('page-title', 'Edit Account Transaction')
...
<div class="grid grid-cols-1 gap-6">
    <div class="md-card">
        ...
        <div class="md-card-content">
            <form action="{{ route('accounts.transactions.update', $transaction->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="reference_number" id="reference_number" 
                           ...
                           value="{{ old('reference_number', $transaction->reference_number) }}" placeholder="e.g. CHQ-001, TXN-123">
