...
@section('breadcrumb', 'Create Purchase')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Create New Purchase Order</h2>

            <form method="POST" action="{{ route('purchases.store') }}" class="space-y-6" id="purchaseForm">
                @csrf
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-medium" id="subtotal">{{ config('currency.symbol') }}0.00</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Discount:</span>
                                <span class="text-sm font-medium" id="discount">{{ config('currency.symbol') }}0.00</span>
                            </div>
                            <div class="flex justify-between border-t pt-2">
                                <span class="text-lg font-semibold text-gray-900">Total:</span>
                                <span class="text-lg font-bold text-green-600" id="total">{{ config('currency.symbol') }}0.00</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<template id="productRowTemplate">
    <tr class="product-row">
        ...
        <td class="px-6 py-4">
            <span class="text-sm font-medium item-total">{{ config('currency.symbol') }}0.00</span>
        </td>
        <td class="px-6 py-4">
