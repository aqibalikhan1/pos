...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="stats-card">
            ...
            <div class="stats-card-value">{{ $customers->count() }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Active Customers</div>
            <div class="stats-card-value">{{ $activeCustomers ?? 0 }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-value">{{ $inactiveCustomers ?? 0 }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Tax Filers</div>
            <div class="stats-card-value">{{ $taxFilers ?? 0 }}</div>
        </div>
    </div>
    ...
    <div class="md-card">
        <div class="md-card-header">
            <div class="flex justify-between items-center">
                <h2 class="md-card-title">All Customers</h2>
                <a href="{{ route('customers.create') }}" class="md-button md-button-primary">
        ...
        <div class="md-card-content">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 data-table" id="customersTable" data-auto-init="true"s >
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mr-3 shadow-sm">
                                        <i class="material-icons text-blue-600 text-sm">person</i>
                                    </div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">{{ $customer->full_name }}</div>
                                        <div class="text-sm text-gray-500">{{ $customer->cnic ?? 'No CNIC' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 text-lg mb-4">No customers found</p>
                                    <a href="{{ route('customers.create') }}" class="md-button md-button-primary">
                                        <i class="material-icons mr-2">add</i>
    ...
    $(document).ready(function() {
        $('#customersTable').DataTable({
            ...
            initComplete: function() {
                ...
                $('.dataTables_filter input').addClass('md-input').attr('placeholder', 'Search customers...');
                
                // Style the length menu
                $('.dataTables_length select').addClass('md-input');
                
                // Add loading state
                $('#customersTable').addClass('loaded');
            }
        });
    });
</script>
