        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="address" id="address" rows="3" 
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $customer->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <select name="town_id" id="town_id" 
                            ...
                            @foreach($towns as $town)
                                <option value="{{ $town->id }}" {{ old('town_id', $customer->town_id) == $town->id ? 'selected' : '' }}>
                                    {{ $town->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select name="is_filer" id="is_filer" 
                                ...
                                <option value="1" {{ old('is_filer', $customer->is_filer) == 1 ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('is_filer', $customer->is_filer) == 0 ? 'selected' : '' }}>No</option>
                            </select>
                            @error('is_filer')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div>
                        <label for="is_active" class="block text-sm font-medium text-gray-700">Customer Status</label>
