...
@section('breadcrumb', 'Employees / Create')
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div class="flex items-center">
                <div class="p-2 bg-white/10 rounded-lg mr-4">
                    <i class="material-icons text-white text-2xl">person_add</i>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-white">Create New Employee</h2>
                    <p class="text-blue-100 text-sm">Add a new employee to your organization</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select name="employee_type" 
                                    ...
                                    <option value="Order Booker" {{ old('employee_type') == 'Order Booker' ? 'selected' : '' }}>Order Booker</option>
                                    <option value="DeliveryMan" {{ old('employee_type') == 'DeliveryMan' ? 'selected' : '' }}>DeliveryMan</option>
                                    <option value="Driver" {{ old('employee_type') == 'Driver' ? 'selected' : '' }}>Driver</option>
                                    <option value="Helper" {{ old('employee_type') == 'Helper' ? 'selected' : '' }}>Helper</option>
                                    <option value="Kpo" {{ old('employee_type') == 'Kpo' ? 'selected' : '' }}>Kpo</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
