        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Create a new product for your inventory management</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="flex items-center justify-between p-3 border border-gray-100 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <select name="tax_rate_types[{{ $taxRate->id }}]" 
                                            ...
                                            <option value="both" {{ old('tax_rate_types.' . $taxRate->id, 'both') == 'both' ? 'selected' : '' }}>Both</option>
                                            <option value="sale" {{ old('tax_rate_types.' . $taxRate->id) == 'sale' ? 'selected' : '' }}>Sales Only</option>
                                            <option value="purchase" {{ old('tax_rate_types.' . $taxRate->id) == 'purchase' ? 'selected' : '' }}>Purchases Only</option>
                                        </select>
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select name="packaging_type" id="packaging_type" required 
                                    ...
                                    <option value="carton" {{ old('packaging_type', 'carton') == 'carton' ? 'selected' : '' }}>Carton</option>
                                    ...
                                    <option value="packet" {{ old('packaging_type') == 'packet' ? 'selected' : '' }}>Packet</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <i class="material-icons text-gray-400">arrow_drop_down</i>
                                </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" name="pieces_per_pack" id="pieces_per_pack" value="{{ old('pieces_per pack', 1) }}" required 
