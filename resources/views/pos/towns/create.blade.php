...
@section('title', 'Create Town')
@section('page-title', 'Add New Town')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Add New Town</h2>

            <form method="POST" action="{{ route('towns.store') }}" class="space-y-6">
                @csrf
