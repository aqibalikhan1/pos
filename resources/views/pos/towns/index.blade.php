...
@section('title', 'Towns')
@section('page-title', 'Towns Management')
@section('breadcrumb', 'Towns')
...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="stats-card">
            ...
            <div class="stats-card-title">Total Towns</div>
            <div class="stats-card-value">{{ $towns->count() }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Active Towns</div>
            <div class="stats-card-value">{{ $towns->where('status', true)->count() }}</div>
        </div>
        ...
        <div class="stats-card">
            ...
            <div class="stats-card-title">Inactive Towns</div>
            <div class="stats-card-value">{{ $towns->where('status', false)->count() }}</div>
        </div>
    </div>
    ...
    <div class="md-card">
        <div class="md-card-header">
            <div class="flex justify-between items-center">
                <h2 class="md-card-title">All Towns</h2>
                <a href="{{ route('towns.create') }}" class="md-button md-button-primary">
        ...
        <div class="md-card-content">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 data-table" id="townsTable">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center shadow-sm">
                                            <i class="material-icons text-blue-600 text-lg">location_city</i>
                                        </div>
                                        <div class="ml-4">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        <i class="material-icons text-6xl text-gray-300 mb-4">location_city</i>
                                        <p class="text-gray-500 text-lg mb-4">No towns found</p>
                                        <a href="{{ route('towns.create') }}" class="md-button md-button-primary">
                                            <i class="material-icons mr-2">add</i>
                                            Add Your First Town
                                        </a>
...
<script>
    $(document).ready(function() {
        $('#townsTable').DataTable({
            ...
            language: {
                search: "Search towns:",
                lengthMenu: "Show _MENU_ towns per page",
                info: "Showing _START_ to _END_ of _TOTAL_ towns",
                infoEmpty: "No towns found",
                infoFiltered: "(filtered from _MAX_ total towns)",
                emptyTable: "No towns available",
                zeroRecords: "No towns match your search",
                paginate: {
            ...
            initComplete: function() {
                ...
                $('.dataTables_filter input').addClass('md-input').attr('placeholder', 'Search towns...');
                
                // Style the length menu
                $('.dataTables_length select').addClass('md-input');
                
                // Add loading state
                $('#townsTable').addClass('loaded');
            }
        });
    });
</script>
